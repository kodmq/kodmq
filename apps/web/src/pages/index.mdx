...
<div className="not-prose">
  <h1 className="text-center font-black text-white text-4xl mb-1 translate-x-6">
    KodMQ
    <sup className="font-normal text-indigo-500">βeta</sup>
  </h1>

  <p className="text-center text-gray-500">Because development must be simple</p>
</div>

## Overview

**KodMQ** is a handy tool for Node.js to help you manage background jobs using either Redis or Prisma.
