...
This installation guide assumes that you are using [bun](https://bun.io/) and [TypeScript](https://www.typescriptlang.org/).
...
import { Idle, Busy, Stopped } from "kodmq/constants"
import kodmq from "./jobs"
