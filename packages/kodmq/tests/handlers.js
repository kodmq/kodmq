...
exports.handlers = exports.longRunningJob = exports.promotionMessage = exports.happyBirthdayMessage = exports.welcomeMessage = void 0;
function welcomeMessage(name) {
    console.log("Welcome, ".concat(name, "!"));
}
exports.welcomeMessage = welcomeMessage;
function happyBirthdayMessage(_a) {
    var name = _a.name, age = _a.age;
    console.log("Happy ".concat(age, "th birthday, ").concat(name, "!"));
}
exports.happyBirthdayMessage = happyBirthdayMessage;
function promotionMessage(promoted) {
    if (promoted) {
...
exports.longRunningJob = longRunningJob;
exports.handlers = {
