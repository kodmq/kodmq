...
const buttonVariants = cva([
  ...
  variants: {
    variant: {
      ...
      skyGlassy: "bg-sky-500/10 text-sky-600 enabled:hover:bg-sky-500/20 disabled:bg-sky-500/5 dark:text-sky-700",
      greenGlassy: "bg-green-500/10 text-green-600 enabled:hover:bg-green-500/20 disabled:bg-green-500/5 dark:text-green-700",
      yellowGlassy: "bg-yellow-500/10 text-yellow-700 enabled:hover:bg-yellow-500/20 disabled:bg-yellow-500/5 dark:text-yellow-700",
      amberGlassy: "bg-amber-500/10 text-amber-700 enabled:hover:bg-amber-500/20 disabled:bg-amber-500/5 dark:text-amber-700",
      redGlassy: "bg-red-500/10 text-red-600 enabled:hover:bg-red-500/20 disabled:bg-red-500/5 dark:text-red-700",
    },
    size: {
